package com.gcloud.p2pms.stack;
...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        DatabaseInstance authServiceDb = createDatabase("AuthServiceDB", "p2pms-auth-service-db");
        DatabaseInstance patientServiceDb = createDatabase("PatientServiceDB", "p2pms-patient-service-db");
        ...
        FargateService authService = createFargateService(
                ...
                Map.of("JWT_SECRET", "g2ZiR+ljtIlGiHi+u6nNSnLh55xhwFuC4ZGzKwzF6YQ=")
        );
        ...
        FargateService patientService = createFargateService(
                "PatientService", "patient-service", List.of(4000), patientServiceDb,
                Map.of(
    ...
    private CfnCluster createMskCluster() {
        return CfnCluster.Builder
                ...
                .clusterName("p2pms-kafka-cluster")
                .kafkaVersion("2.8.0")
